...
```{r rmarkdown1, fig.cap="Create a new RMarkdown file", fig.align='center', out.width='60%', eval = TRUE, echo = FALSE}
...
```{r rmarkdown2, fig.cap="Create a new RMarkdown file", fig.align='center', out.width='60%', eval = TRUE, echo = FALSE}
...
```{r rmarkdown3, fig.cap="Knitting an RMarkdown file", fig.align='center', out.width='60%', eval = TRUE, echo = FALSE}
